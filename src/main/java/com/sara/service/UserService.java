...
public class UserService {
    ...
    public User saveUser(User user) {
        ...
        // Only volunteers need admin verification; others are auto-verified
    ...
    public List<User> findUnverifiedVolunteers() {
        return userRepository.findByRole(User.UserRole.VOLUNTEER).stream()
